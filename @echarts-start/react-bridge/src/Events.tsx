...
export interface IChartEventProps {
  //mouse
  onChartClick?: (e: IChartMouseEvent) => void;
  onChartDbClick?: (e: IChartMouseEvent) => void;
  onChartMouseDown?: (e: IChartMouseEvent) => void;
  onChartMouseMove?: (e: IChartMouseEvent) => void;
  onChartMouseUp?: (e: IChartMouseEvent) => void;
  onChartMouseOver?: (e: IChartMouseEvent) => void;
  onChartMouseOut?: (e: IChartMouseEvent) => void;
  onChartGlobalOut?: (e: IChartMouseEvent) => void;
  onChartContextMenu?: (e: IChartMouseEvent) => void;
  //
  onLegendSelectChanged?: (e: ILegendEvent) => void;
  onLegendSelected?: (e: ILegendEvent) => void;
  onLegendUnSelected?: (e: ILegendEvent) => void;
  onLegendSelectAll?: (e: ILegendEvent) => void;
  onLegendInverseSelect?: (e: ILegendEvent) => void;
  onLegendScroll?: (e: IChartEvent["legendscroll"]) => void;
  //
  onDataZoom?: (e: IDataZoomEvent) => void;
  onDataRangeSelected?: (e: IChartEvent["datarangeselected"]) => void;
  onTimelineChanged?: (e: IChartEvent["timelinechanged"]) => void;
  onTimelinePlayChanged?: (e: IChartEvent["timelineplaychanged"]) => void;
  onRestore?: (e: IChartEvent["restore"]) => void;
  onDataViewChanged?: (e: IChartEvent["dataviewchanged"]) => void;
  onMagicTypeChanged?: (e: IChartEvent["magictypechanged"]) => void;
  //
  onGeoSelectChanged?: (e: ISeriesEvent) => void;
  onGeoSelected?: (e: ISeriesEvent) => void;
  onGeoUnSelected?: (e: ISeriesEvent) => void;
  onPieSelectChanged?: (e: ISeriesEvent) => void;
  onPieSelected?: (e: ISeriesEvent) => void;
  onPieUnSelected?: (e: ISeriesEvent) => void;
  onMapSelectChanged?: (e: ISeriesEvent) => void;
  onMapSelected?: (e: ISeriesEvent) => void;
  onMapUnSelected?: (e: ISeriesEvent) => void;
  //
  onAxisAreaSelected?: () => void;
  onFocusNodeAdjacency?: () => void;
  onUnFocusNodeAdjacency?: () => void;
  onBrush?: () => void;
  onBrushEnd?: () => void;
  onBrushSelected?: (e: any) => void;
  onGlobalCursorTaken?: (e: any) => void;
  onRendered?: () => void;
  onFinished?: () => void;
}

//compose
export const ChartEvents = (props: IChartEventProps) => {
  return (
    <>
      {map(props, (handler, funcName) => {
        const eventName: keyof IChartEvent = get(EventFuncKeyMap, funcName);
        return <Event key={funcName} eventName={eventName} eventHandler={handler} />;
      })}
    </>
  );
};
